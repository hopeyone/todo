...
class TodoResourceIT {
    ...
    public static Todo createEntity(EntityManager em) {
        Todo todo = new Todo().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).due(DEFAULT_DUE);
        return todo;
    }
    ...
    public static Todo createUpdatedEntity(EntityManager em) {
        Todo todo = new Todo().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).due(UPDATED_DUE);
        return todo;
    }
    ...
    void createTodo() throws Exception {
        ...
        assertThat(testTodo.getDue()).isEqualTo(DEFAULT_DUE);
    }
    ...
    void putExistingTodo() throws Exception {
        ...
        updatedTodo.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).due(UPDATED_DUE);
        ...
        assertThat(testTodo.getDue()).isEqualTo(UPDATED_DUE);
    }
    ...
    void fullUpdateTodoWithPatch() throws Exception {
        ...
        partialUpdatedTodo.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).due(UPDATED_DUE);
